...
SRC_URI:append = " file://xyz.openbmc_project.Hwmon_hostoff@.service"
SRC_URI:append = " file://olympus-reload-sensor.sh"
#SRC_URI:append = " file://0001-lev-add-poweron-monitor-feature.patch"
SRC_URI:append = " file://olympus-reload-sensor-on.service"
SRC_URI:append = " file://olympus-reload-sensor-off.service"

SYSTEMD_SERVICE:${PN}:append = " olympus-reload-sensor-on.service"
SYSTEMD_SERVICE:${PN}:append = " olympus-reload-sensor-off.service"
SYSTEMD_SERVICE:${PN}:append = " xyz.openbmc_project.Hwmon_hostoff@.service"
SYSTEMD_SERVICE:${PN}:append = " olympus-reload-sensor-on.service"
SYSTEMD_SERVICE:${PN}:append = " olympus-reload-sensor-off.service"
...
SYSTEMD_ENVIRONMENT_FILE:${PN}:append = " ${@compose_list(d, 'PECIENVS', 'PECIITEMS')}"

EXTRA_OEMESON:append = " -Dupdate-functional-on-fail=true"
