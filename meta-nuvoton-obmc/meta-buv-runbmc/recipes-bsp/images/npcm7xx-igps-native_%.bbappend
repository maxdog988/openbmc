...
do_install:append() {
	install -d ${DEST}
	install -m 0644 ${UNPACKDIR}/BootBlockAndHeader_RunBMC.xml ${DEST}/BootBlockAndHeader_${IGPS_MACHINE}.xml
	install -m 0644 ${UNPACKDIR}/UbootHeader_RunBMC.xml ${DEST}/UbootHeader_${IGPS_MACHINE}.xml 
	install -m 0644 ${UNPACKDIR}/poleg_key_map.xml ${DEST}/
	install -m 0644 ${UNPACKDIR}/poleg_fuse_map.xml ${DEST}/
